...
const Eventprofile1 = () => {
  ...
  return (
    <div className="flex justify-center items-center origin-center pb-10 font-sans">
      <div className="w-3/4 flex flex-col justify-center self-center b">
        ...
        <div className="flex flex-row -mt-8">
          <div className="w-2/3 mr-5 border-2 flex flex-col shadow-md p-2 bg-white">
            {event.eventMode === "offline" ? (
              <>
                <p className="font-semibold text-3xl">
                  {" "}
                  {event.title} <a className="text-xl font-medium">(Offline)</a>
                </p>
              ...
              <>
                <p className="font-semibold text-3xl">
                  {" "}
                  {event.title} <a className="text-xl font-medium">(Online)</a>
                </p>
                <p className="font-medium text-lg mt-2">
            ...
            {event.userId && (
              <p className="font-medium text-green-600 cursor-pointer text-lg" onClick={()=>{
                    navigate(`/organization/${event.userId._id}`) 
              }}>
          ...
          <div className="w-1/3 justify-center  items-center p-4">
            <form
              ...
              className="max-w-1/3 mx-auto p-4 bg-white shadow-md rounded-md"
            >
                ...
                </button>
            {
                event.meetinglink && (
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={()=>{
                       navigate(`/room/${event.meetinglink}`)
                    }}>
                      Join Meeting
                    </button>
                )
              ...
              {/* Rating Section */}
              <div className="mb-4">
                <label htmlFor="rating" className="block font-medium text-base">
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  value={feedback.experience} // Fix made here
